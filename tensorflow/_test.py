...
url = "/Users/gbodacs/Documents/programming_languages/tensorflow/IBM.csv"
dataframe = read_csv(url, usecols=[4])
dataset = dataframe.values
dataset = dataset[0:9140]
...
train_size = 9000 #int(len(dataset) * 0.5)
test_size = 125 #len(dataset) - train_size
