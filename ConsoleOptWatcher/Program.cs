...
namespace ConsoleOptWatcher
{
    class Program
    {
        ...
        private void MyTime(Boolean MyEmergency)
        {
        ...
        private static void MyWriteForegroundColor(ConsoleColor MyColor)
        {
        ...
        private static void OnTimedEvent(Object source, ElapsedEventArgs e)
        {
            ...
            string path = @"c:\\test.txt";
                ...
                if (MyHTMLParser.IsThereProblem(htmlCode) == false) //ha nem talalta a hibauzenetet akkor johet az adatelemzes
                {
                   ...
                   string[] words =  MyHTMLParser.TableSplitter(MyHTMLParser.ExtractTable(htmlCode));
                    /////////////////////////////////////////////////itt jarok az atirasban es meg nincs meg a kulon file kezelo ami a dolgokat kiirja 
                    //ill kell egy kulon konzolkezelo kiiro is talan bar az eleg egyszeru. lehet kellene csinalni egy log osztalyt
